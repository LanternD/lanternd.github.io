(function() {
    ...
    if (!narrow_screen) {
        ...
        console.log("Generate side bar navigation TOC");
        (function() {
            ...
            function genIndex() {
                ...
                // Jump to header link when click on sidebar toc item
                $('#menuIndex')
                    .append($(tmpl))
                    .delegate('a', 'click', function(e) {
                        ...
                        $('body, html').animate({
                            scrollTop: verticalScrollPosition - 30
                        }, 400, 'swing');
                    });
            }
            ...
            if ($('.entry h2').length > 2) {
                ...
                // Highlight side bar toc item w.r.t page offset
                $(window).load(function() {
                    ...
                    $(window).scroll(function() {
                        waitForFinalEvent(function() {
                            ...
                            if (nowTop + 60 > scrollTopList[length]) {
                                index = length;
                            } else {
                            ...
                            // Keep the side TOC stick to top edge.
    ...
    // Adjust vertical position when visiting page with anchor link.
