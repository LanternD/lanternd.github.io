...
var Lattespirit = function () {
    function Lattespirit() {
        _classCallCheck(this, Lattespirit);
    ...
    _createClass(Lattespirit, [{
        ...
        key: 'handleInputBoxInSearchPage',
        value: function handleInputBoxInSearchPage() {
            $('.ls-search-page-input').focus();
        }
    }, {
        key: 'handleSearchModal',
        value: function handleSearchModal() {
            ...
            $(document).on('keyup', function (e) {
                ...
                if (e.which === 83 && tag != 'input' && !this.isModalOpened) {
                    $('#search-modal').modal('show');
                }
            });
        }
    }, {
        key: 'handleAboutPageByDevice',
        value: function handleAboutPageByDevice() {
        ...
        key: 'handleMobileSearchNavbar',
        value: function handleMobileSearchNavbar() {
        ...
        key: 'generateSearchResult',
        value: function generateSearchResult(inputObject, wrapper, additional) {
        ...
        key: 'generateDisplay',
        value: function generateDisplay(selectedArticles, wrapper) {
            var index = 0,
                display = '',
                selectedArticle = '';
