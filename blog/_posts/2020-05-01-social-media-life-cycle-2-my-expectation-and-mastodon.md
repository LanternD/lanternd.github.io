...
　如上面文章简介所述，我折腾完了Mastodon，建立起了一个自己的实例（[https://t.dlyang.me]({{ site.author.mastodon }})）（注：原文是 https://dlyang.tk - 已失效），并已经稳定运行了30天。这个应该不是我折腾的终点，却可以作为一个大的Checkpoint或者说里程碑。

　~~我给这个站点取名DY-Talk，只是因为 `.tk` 域名不要钱，正好它又是Talk的缩写。~~

　（2025.07.14 更新：又一次印证了「免费的就是最贵的」。因为有一年我忘记续 `.tk` 域名于是被收回去了。本着省钱的原则，我直接弄了个子域名 t.dlyang.me 接着用了。）
...
　我有很多的东西想记录，大部分东西也不够有趣，如果每一条都发朋友圈，无疑会打扰到很多人。况且真的有人回复了，我还得响应。Mastodon就给了我一层很好的隔离：如果真正对我的三言两语感兴趣的人，便不会吝惜多点一次链接跳转到我的 [DY-Talk]({{ site.author.mastodon }}) 上。我可以很好地避开大部分人的无效关注，既不需要他们点赞评论，也不影响别人的时间线。我现在需要做的只是把 [公开状态流的链接]({{ site.author.mastodon }}/public) 贴到个人简介里，感兴趣的人自然就来看了。
